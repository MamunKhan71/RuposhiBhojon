...
const AuthProvider = ({ children }) => {
    ...
    useEffect(() => {
        const unsubscribe = onAuthStateChanged(auth, (currentUser) => {
            ...
            setLoading(false)
            if (currentUser) {
                axios.post('https://ruposhi-bhojhon.vercel.app/jwt', loggedUser, { withCredentials: true })
                    .then(res => console.log(res.data))
            } else {
                axios.post('https://ruposhi-bhojhon.vercel.app/logout', loggedUser, { withCredentials: true })
                    .then(res => console.log(res.data))
            }
        })
        return unsubscribe;
