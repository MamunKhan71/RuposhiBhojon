                    ...
                    </label>
                    {
                        loading ? <span className="loading loading-ring loading-lg"></span> :
                            user ? <div className="dropdown dropdown-end">
                                <div tabIndex={0} role="button" className="btn btn-circle m-1"><img className="w-full h-full rounded-xl ring ring-primary ring-offset-base-100 ring-offset-2" src={user?.photoURL} /></div>
